//
//  ZaterdagTableViewController.swift
//  Paaspop
//
...
class ZaterdagTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.timeLabel.text = String(indexPath.row + 12) + ":15-" + String(indexPath.row + 13) + ":15"
